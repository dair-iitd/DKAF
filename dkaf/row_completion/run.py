...
from utils import read_cli, train_file, load_json, get_optimizer, get_model, infer_file
...
val_fname = os.path.join(args['data_loc'], infer_file)
if args["use_mapo"]:
    env = MAPOEnvironment(
...
model = get_model(args, LatentLinkerAgent)
