...
class Vocabulary(object):
    def __init__(self):
        ...
        self.all_latent_entities = ['0', '1', '2', '3', '4', '5']
    ...
    def fit(self, data):
        ...
        # print(max_ctx_len)
        self.max_pos_cnt = max_ctx_len - 2 ## what does this do?
    ...
    def transform_context(self, entry, mode='infer'):
        ...
        source_type, source_node, src_uttr_idx, src_uttr_pos = entry['ent']
        ...
        node_uttr_idx, node_uttr_pos = src_uttr_idx, src_uttr_pos
